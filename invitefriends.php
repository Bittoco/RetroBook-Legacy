...
<head>
	...
	<title>theretrobook | Invite friends</title>
	<meta charset="utf-8">
 	<meta name="viewport" content="width=device-width, initial-scale=1">
...
<div class="welcome">
	...
	echo "<p class='welcometext'>Invite friends to ".$row['name']."</p>";
	}
	} else {
		header("location: home.php");
	}
			...
			if($resultCheck > 0) {
				...
				$gend = "Them";
					...
					while($row3 = mysqli_fetch_assoc($result3)) {
						...
						$flink = 'removef.inc.php?roo='.$id1.'&id='.$_SESSION['id'].'';
					} 
						...
						$flink = 'friend.inc.php?foo='.$id1.'+id='.$_SESSION['id'].'';
					}
				...
				<td class="searchfor"><a style="color:#3B5998;text-decoration: none;" href="invite.inc.php?gid='.$_GET['gid'].'&id='.$row['id'].'">Invite '.$gend.'</a><tr>
				<td class="viewfriends"><a style="color:#3B5998;text-decoration: none; >View Friends</a><tr>
				<td class="viewgroups"><a style="color:#3B5998; text-decoration: none;" >u</a><tr>	
			</table>';
