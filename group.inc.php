...
if(isset($_POST['resubmit'])) {
	...
	$id = htmlspecialchars($_POST['id'], ENT_QUOTES, 'UTF-8');
	$id = mysqli_real_escape_string($conn,  $id);
	$com = htmlspecialchars($_POST['com'], ENT_QUOTES, 'UTF-8');
	...
	$date3 = date("Y-m-d");
     ...
     $uid = $_SESSION['id'];
       ...
       $sql2 = "INSERT INTO wall (fromname, fromid, typewall, noteid, date, altdate) VALUES ('$email', '$uid', 'Group Reply', '$id', '$date', '$date4')";
		$result2 = $conn->query($sql2);
	$sql = "INSERT INTO replies (creatorid, creatorname, ogmessage, text, date) VALUES ('$uid', '$name', '$id', '$reply', '$date')";
	$result = $conn->query($sql);
	header("location: viewmessage.php?id=".$id."");
...
if(isset($_POST['csubmit'])) {
	...
	$date3 = date("Y-m-d");
     ...
     $sql2 = "INSERT INTO wall (fromname, fromid, typewall, noteid, date, altdate) VALUES ('$email', '$uid', 'Group Comment', '$group','$date', '$date4')";
		$result2 = $conn->query($sql2);
...
if(isset($_POST['cresubmit'])) {
	...
	$sql2 = "INSERT INTO wall (fromname, fromid, typewall, date, altdate) VALUES ('$creator', '$id', 'Create Group', '$date', '$altdate')";
	$result2 = $conn->query($sql2);
