...
<head>
	...
	<title>retrobook | Preview Note</title>
	<meta charset="utf-8">
 	<meta name="viewport" content="width=device-width, initial-scale=1">
...
<div class="welcome">
	...
	<p class='welcometext'>My Notes</p>
	<div class="border">
		<div class="borderheader"><p>Preview Note</p></div>
		<h2 class="loginsign"></h2>
		<form method="get" action="note.inc.php">
		<div class="options">
			<b class="pr">This is a preview Note.</b>
		</div>
		<div class="note">
			<?php 
