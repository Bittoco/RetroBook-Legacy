...
<div class="welcome">
	...
	<div class="border">
		...
		?>
		<form method="post" action="grouppfp.inc.php" enctype="multipart/form-data">
		<div class="form1">
	...
	<form method="post" action="grouppfp.inc.php">
	<input type="hidden" name="id" value="<?php echo $id; ?>">
	<button class="reg" type="submit" name="gsubmit">Remove Photo</button>
	</form>
	</div>
	<?php 
	if(isset($_GET['e'])) {
