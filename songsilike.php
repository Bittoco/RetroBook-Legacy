...
<div class="welcome">
	<p class="welcometext">Songs iLike</p>
	<div class="border"><br>
		<?php include 'topbunk.php';
		?>
	<div class="white">
		<div class="text">
			<img src="img/ilike.png" class="ilike"/>Songs added to your profile<br><br></div>
			<?php 
			$email = $_SESSION['email'];
			$sql5 = "SELECT * FROM profilesongs WHERE email = '$email'";
				$result5 = $conn->query($sql5);
				if(mysqli_num_rows($result5) > 0) {
					echo '<div class="songsadded"><gi>Songs Added Onto Your Profile</gi><di>Displaying '.mysqli_num_rows($result5).' songs.</di></div>';
