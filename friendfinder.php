...
<div class="welcome">
	<?php 
	echo "<p class='welcometext'>Friend Finder</p>";
	...
	<div class="border">
		...
		$id = $_SESSION['id'];
			...
			echo '<div class="options">
				<a style="text-decoration: none;" href="friends.php?id='.$_SESSION['id'].'"><div class="option" style="background: white; color: #3B5998;">Friends List</div></a>&nbsp;<a style="text-decoration: none;" href="friendfinder.php"><div class="option">Friend Finder</div></a>
				&nbsp;<a style="text-decoration: none;" href="friendgame.php"><div class="option" style="background: white; color: #3B5998;">Friend Game</div></a></a>
				</div>';
			while($row2 = mysqli_fetch_assoc($result2)) {
				$name = $row2['name'];
				$music = $row2['music'];
				$interests = $row2['interests'];
				$about = $row2['aboutme'];
    $interested = $row2['interested'];
    $rstatus = $row2['rstatus'];
				$sql = "SELECT * FROM users WHERE music LIKE '%$music%' OR interests LIKE '%$interests%' OR interested LIKE '%$interested%' OR rstatus LIKE '%$rstatus%'";
				...
				$gend = "Them!";
					...
					while($row3 = mysqli_fetch_assoc($result3)) {
						...
						$flink = 'removef.inc.php?roo='.$id1.'&id='.$row['id'].'';
					} 
						...
						$flink = 'friend.inc.php?fid='.$id1.'+id='.$_SESSION['id'].'';
					}
				...
				<td class="searchfor"><a style="color:#3B5998;text-decoration: none;" href="poke.inc.php?pok='.$id1.'&id='.$row['id'].'">Poke '.$gend.'</a><tr>
