...
<div class="welcome">
	...
	<div class="border">
		...
		<div class="info">
			...
			<a class="yourprofile" style="color: #3B5998;" href="tourprofile.php">Your Profile</a>
			<a href="tournotes.php"><img src="photonote.gif" class="icon3"/></a>
			<a class="photonotes" style="color: #333333;" href="tournotesphp">Photo and Notes</a>
		...
		<div class="tour">
			<p class="started">Upload Photos and Write Notes</p>
			<p class="isnot">Retrobook lets you post as many photos as you want. You can upload photos and notes from your mobile phone, computer, or anywhere.</p>
			<img src="photos.png" class="register"></img>
			<p class="lower">Publish Notes</p>
			<p class="from">You can also share your thoughts by writing notes, or blogs. You can import photos.</p>
			<img src="notetour.png" class="notetour"></img>
		</div>
	</div>
