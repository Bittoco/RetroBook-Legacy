...
<div class="welcome">
	...
	<div class="border">
		...
		<div class="info">
			...
			<a class="getstarted" style="color: #333333;" href="tourindex.php">Getting Started</a>
		...
		<div class="tour">
			<p class="started">Get started on retrobook</p>
			<p class="isnot">retrobook is an online community of <b>seperate networks</b> based around things like projects, companies, and schools.</p>
			<img src="register.png" class="register"></img>
			<p class="lower">Anyone can sign up for Retrobook</p>
			<p class="from">From your friends to your grandmother, the retrobook offers the abilty to browse people all around the globe. </p>
		</div>
	</div>
