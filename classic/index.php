...
<div class="welcome">
	...
	<div class="border">
		<p class="desc">
			The retrobook is a online directory to connect people who miss an era long gone by.<br><br><br>Rather than a exclusive College Connection, theretrobook allows anyone <br>to signup.<br><br>You can use the retrobook to: <br><br>
			• View profiles <br>
			• Find new people<br>
			• Find old friends<br>
		</p>
